...
if __name__ == "__main__":
    ...
    attack = UniversalPerturbation(classifier=classifier, attacker="deepfool", delta=0.5, eps=100, batch_size=64,
                                   verbose=True, max_iter=30)
    ...
    # save perturbation noise and corresponding fooling rate on first 100 training images
